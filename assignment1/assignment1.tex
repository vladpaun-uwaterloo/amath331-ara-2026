...
\begin{answer}
    \begin{proof}
        Let $u=\frac{x}{\lVert x\rVert}$ and $v=\frac{y}{\lVert y\rVert}$.

        \emph{Gotta add the proof for the inequalities here}
        ...
        Let us now look at $\ip{u}{v}$
        \[
            \ip{u}{v} = \ip{\frac{x}{\norm{x}}}{\frac{y}{\norm{y}}} = \frac{\ip{x}{y}}{\norm{x}\norm{y}} = 1
        \]
        Let $z = u - v$.
        \begin{align*}
            &\norm{z}^2 = \ip{z}{z} = \ip{u-v}{u-v} = \ip{u}{u} -2\ip{u}{v} + \ip{v}{v}\\
            &\norm{z}^2 = \norm{u}^2 + \norm{v}^2 - 2\\
            && \norm{u} = \norm{\frac{x}{\norm{x}}} = \frac{\norm{x}}{\norm{x}} = 1\\
            && \norm{v} = \norm{\frac{y}{\norm{y}}} = \frac{\norm{y}}{\norm{y}} = 1\\
            &\norm{z}^2 = 2-2=0\\
