...
\begin{parts}
    ...
    \begin{answer}
        \begin{proof}
            ...
            Now, we know that
            \begin{align*}
                \forall \epsilon > 0&:\ \exists \alpha\in A:\ \inf A + \frac{\epsilon}{2}  > \alpha \\
                \forall \epsilon > 0&:\ \exists \beta\in B:\ \inf B + \frac{\epsilon}{2}  > \beta \\
            \end{align*}

            Therefore,
            \begin{align*}
                \forall \epsilon > 0&:\ \exists \alpha\in A, \beta\in B:\ \inf A + \inf B + \epsilon  > \alpha + \beta \\
            \end{align*}
